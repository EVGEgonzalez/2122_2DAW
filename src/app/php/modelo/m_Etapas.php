...
class M_Etapas{
    ...
    {
      require_once __DIR__ . "/m_OperacionesBD_Etapas.php";
      $this->conexion = new  M_Etapas_Operaciones();
  ...
  function listarPoblaciones(){
    $consulta="
      SELECT idEtapa,duracion,kilometros,imgEtapa,poblacioninicio.nombrePoblacion as 'nombreInicio',poblacionfinal.nombrePoblacion as 'poblacionFinal'
      FROM etapas
